...
/**
 * Servlet implementation class updateInDeliveryServlet
 */
@WebServlet("/updateInDeliveryServlet")
public class updateInDeliveryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updateInDeliveryServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session.getAttribute("type") != null && session.getAttribute("type").equals("Admin")) {
			...
			int returnCode = buyorderService.updateInDeliveryOrder(orderid);
			if(returnCode == 1) {
