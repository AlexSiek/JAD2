		...
		<!-- SHOWING CART ITEMS -->
			<div class="productsContent col-md-8 col-12">
				<%
					...
					try {
						...
						ResultSet rs = fetchUserCart(userId,connDup);//Fetches everything in user cart
							...
							out.println("<a href=\"listing.jsp?id="+productId+"\" class=\"text-decoration-none\"><img class=\"img-fluid\" src=\"../images/" + imgURL + "\"></a>");
							out.println("</div>");
							String removeIcon = "<a href=\"../SQLFiles/deleteCartItem.jsp?cartId="+cartId+"\"><img src=\"../images/removeIcon.png\" class=\"trashImg img-fluid\" alt=\"removeIcon.png\"></a>";
							out.println("<div class=\"col-8\"><h4><a href=\"listing.jsp?id="+productId+"\" class=\"text-decoration-none text-reset\">"+productName+"</a>"+removeIcon+"</h4>");
							out.println("<span class=\"text-warning font-weight-bold\">"+String.format("%.2f", buyPrice)+" SGD</span><br>");
							if (qty < 5) {
							...
							out.println("<p class=\"text-right font-weight-bold text-primary\">Subtotal: "+String.format("%.2f", cartQty*buyPrice)+" SGD</p>");
							out.println("</div>");
				...
				if(amountOfProduct==0){
					...
					out.println("<div class=\"emptyCartWrapper d-flex justify-content-center\"><img src=\"../images/emptyCartIcon.png\" alt=\"EmptyCart.png\" class=\"emptyCart img-fluid\"></div>");
					out.println("<p class=\"text-center font-weight-light\">Your Cart is Empty</p>");
					out.println("<div class=\"btnWrapper d-flex justify-content-center\"><a href=\"index.jsp\" class=\"btn btn btn-outline-primary\">Continue Shopping</a></div>");
					out.println("</div>");
				}
				%>
			</div>
			...
			if(amountOfProduct == 0){
				...
				out.println("<div><span class=\"font-weight-light\">Subtotal ("+amountOfProduct+" items)</span><span class=\"font-weight-normal totalPrice\">$"+String.format("%.2f",totalPrice) +"</span></div>");
