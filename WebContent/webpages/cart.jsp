		...
		<div class="initialRow row">
			...
			<div class="checkOutSummary col-md-4 col-12">
				...
				<%
					...
					out.println(
					"<div class=\"checkoutBtn d-flex justify-content-center\"><a href=\"../SQLFiles/checkout.jsp\" class=\"btn btn-outline-warning btn-lg\">Checkout</a></div>");
					if (errId != null) {
						try {
					int pdtErrId = Integer.parseInt(errId);
					out.println(
							"<br><div><span class=\"font-weight-bold text-danger\">There isn't enough stock for one or more of your requested product.</span></div>");
						} catch (Exception e) {
					out.println(e);
						}
					}
